...
namespace Domain.Models
{
    ...
    {       
        ...
        public DateTime Updated_at { get; set; } // database updated
        ...
        public DateTime LastUpdated { get; set; } // api updated time
    ...
    public class CustomerContact
    {
        ...
        public int customerNumber { get; set; }//customer.customerId(or source customer id)
